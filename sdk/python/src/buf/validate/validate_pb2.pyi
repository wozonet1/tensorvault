...
class MessageOneofRule(_message.Message):
    ...
    required: bool
    def __init__(
        self, fields: _Optional[_Iterable[str]] = ..., required: _Optional[bool] = ...
    ) -> None: ...
...
class PredefinedRules(_message.Message):
    ...
    cel: _containers.RepeatedCompositeFieldContainer[Rule]
    def __init__(
        self, cel: _Optional[_Iterable[_Union[Rule, _Mapping]]] = ...
    ) -> None: ...
...
class BoolRules(_message.Message):
    ...
    def __init__(
        self, const: _Optional[bool] = ..., example: _Optional[_Iterable[bool]] = ...
    ) -> None: ...
...
class StringRules(_message.Message):
    ...
    def __init__(
        ...
        email: _Optional[bool] = ...,
        hostname: _Optional[bool] = ...,
        ip: _Optional[bool] = ...,
        ipv4: _Optional[bool] = ...,
        ipv6: _Optional[bool] = ...,
        uri: _Optional[bool] = ...,
        uri_ref: _Optional[bool] = ...,
        address: _Optional[bool] = ...,
        uuid: _Optional[bool] = ...,
        tuuid: _Optional[bool] = ...,
        ip_with_prefixlen: _Optional[bool] = ...,
        ipv4_with_prefixlen: _Optional[bool] = ...,
        ipv6_with_prefixlen: _Optional[bool] = ...,
        ip_prefix: _Optional[bool] = ...,
        ipv4_prefix: _Optional[bool] = ...,
        ipv6_prefix: _Optional[bool] = ...,
        host_and_port: _Optional[bool] = ...,
...
class DurationRules(_message.Message):
    ...
    def __init__(
        ...
        not_in: _Optional[
            _Iterable[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]]
        ] = ...,
        example: _Optional[
            _Iterable[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]]
        ] = ...,
...
class TimestampRules(_message.Message):
    ...
    def __init__(
        ...
        gt_now: _Optional[bool] = ...,
        within: _Optional[
            _Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]
        ] = ...,
        example: _Optional[
            _Iterable[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class FieldPath(_message.Message):
    ...
    def __init__(
        self, elements: _Optional[_Iterable[_Union[FieldPathElement, _Mapping]]] = ...
    ) -> None: ...
